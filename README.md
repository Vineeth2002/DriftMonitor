...
# Collects real public data (Google Trends + HackerNews)
# Output → data/live/raw/YYYY-MM-DD/
# --------------------------------------------------
python scripts/collect/run_collectors.py

# --------------------------------------------------
# 2. Daily Safety Evaluation
# Applies SafetyClassifier on collected data
# Output → data/live/processed/YYYY-MM-DD/
# --------------------------------------------------
